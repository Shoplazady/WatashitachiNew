      ...
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="https://flowbite-admin-dashboard.vercel.app/"
              ...
              <span class="ml-3" sidebar-toggle-item="">หน้าหลัก</span>
            </a>
          </li>
          <li>
            <button type="button"
              class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
              aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts" aria-expanded="false">
              <svg
          ...
          <li>
            <button type="button"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Tags</span>
              <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          ...
          <li>
            <a href="https://flowbite-admin-dashboard.vercel.app/settings/"
              ...
              <span class="ml-3" sidebar-toggle-item="">Coins</span>
            </a>
          </li>
        </ul>
        <div class="pt-2 space-y-2">
          <a href="#" target="_blank"
            ...
            <span class="ml-3" sidebar-toggle-item="">Login</span>
          </a>
          <a href="#" target="_blank"
            class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <span class="ml-3" sidebar-toggle-item="">Sign up</span>
          </a>
        </div>
        <div class="pt-2 space-y-2">
